...
function MapCanvas({
  ...
  useEffect(() => {
    const nextSelectedId = getDefaultSelectedId(course, initialSelectedSlug);
  ...
  }, [course, initialLayoutPositions, initialSelectedSlug, layoutMessage, layoutPersistenceEnabled, mapKey, setNodes]);
